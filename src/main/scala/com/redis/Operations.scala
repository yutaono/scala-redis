...
trait Operations { self: Redis =>
  ...
  @deprecated def randomKey = randkey
  ...
  @deprecated def delete(key: String, keys: String*) = del(key, keys: _*)
  ...
  @deprecated def selectDb(index: Int) = select(index)
  ...
  @deprecated def flushDb = flushdb
